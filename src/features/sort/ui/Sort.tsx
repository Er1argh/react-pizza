...
import { selectSort } from '../model/sort-selectors'

import { sortPropertyEnum } from '../model/sort-types'

import { sortList } from '../../../shared/constants/sortList'
...
const SortPopup: FC = () => {
  ...
  const onSortItemClick = (sortItem: SortListItem) => {
          ...
          <ul>
            {sortList.map(sortItem => (
              <li
                ...
                className={sortProperty === sortItem.sortProperty ? 'active' : ''}>
                {sortItem.name}
              </li>
            ))}
          </ul>
